...
void init()
{
	boxtex = new glTexture("../resource/星空图.png", true);

	sun = new planet("../resource/太阳.png", 0.0f, 1.0f, 1.0f, vec3(0.0f, 0.0f, 0.0f));
	sx = new planet("../resource/水星.png", 0.5f, 0.5f, 0.2f, vec3(1.4f, 0.4f, 0.0f));
	jx = new planet("../resource/金星.png", 0.5f, 0.5f, 0.2f, vec3(3.0f, -0.4f, 0.0f));
	earth = new planet("../resource/地球.png", 1.0f, 2.0f, 0.5f, vec3(5.0f, 2.0f, 8.0f));
	moon = new planet("../resource/月亮.png", 0.5f, 0.5f, 0.2f, vec3(1.5f, 0.0f, 0.0f));
	hx = new planet("../resource/火星.png", 0.2f, 0.3f, 0.3f, vec3(7.0f, 0.0f, 0.0f));
	mx = new planet("../resource/木星.png", 0.4f, 1.0f, 0.5f, vec3(10.0f, 0.0f, 0.0f));
	tx = new planet("../resource/土星.png", -0.4f, 0.2f, 1.0f, vec3(15.0f, 1.0f, 0.0f));
	twx = new planet("../resource/天王星.png", 0.8f, 0.5f, 0.3f, vec3(17.0f, 0.0f, 0.0f));
	hwx = new planet("../resource/海王星.png", 0.6f, 0.5f, 0.4f, vec3(19.0f, 0.8f, 0.0f));

	parttex = new glTexture("../resource/particle.png");

	trail = new glTrail("../resource/spawnflash.png");
...
void myTimerFunc(int val)
{
	...
	glutPostRedisplay();
	glutTimerFunc(val, myTimerFunc, 0);
}
